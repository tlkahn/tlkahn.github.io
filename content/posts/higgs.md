...
-   Photon ({{<katex>}}\gamma{{</katex>}}) - Mediates the electromagnetic force

-   {{<katex>}}W^+{{</katex>}} boson, {{<katex>}}W^-{{</katex>}} boson, and {{<katex>}}Z{{</katex>}} boson - Mediate the weak force

-   Gluon ({{<katex>}}g{{</katex>}}) - Mediates the strong force

##### Higgs Boson

The Higgs boson ({{<katex>}}H{{</katex>}}) is responsible for giving mass to other particles through the Higgs mechanism.
